...
- Solo-shipped a production iOS app, admin dashboard, and web platform in 2 months, reaching 2,000+ users and 26 venues
- Secured a partnership with Warwick Food Group, featured on 140+ campus screens, 450 weekly active users after 10 weeks
- Designed the architecture for AI coding agents to build features across all platforms in parallel using a 1,900-line JSON Schema as single source of truth
